<?php
		...
		$row = $Customer_info->get($i_customer);
		
		$Product_info->primary_key='key_product';
		
		$rowproduct = $Product_info->get($row['key_product']);
		 ...
		 */
			...
			$tpl->setVariable('title',"Efectuar pago de $ {$rowproduct['subscription']}  al cliente : {$row['name']} {$row['surname']}");
			 ...
			 */
				foreach($elements as $value){
					...
					if($form_val['sent_form']!=''){
						...
						$message = $Customer->makepayment($data_mysql,$session_vars);
