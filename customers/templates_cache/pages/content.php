<?php
		 ...
		 */
			...
			$elements = array(
					...
					array('value'=>'0','type'=>'upload','name'=>'imagesite','label'=>'*Logo sitio','folder'=>$File->dir),
					array('value'=>'0','type'=>'upload','name'=>'imagebox','label'=>'*Logo dispositivo','folder'=>$File->dir),
