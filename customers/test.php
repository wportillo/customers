...
class Postpaidmodel extends model {
        ...
        function getAccount($fields = null, $where = null, $limit = null,
$order = null){
...
$this->db->order_by('id','desc');
        ...
        function getAccountList($fields = null, $where = null, $limit = null,
$order = null){
        ...
        //max download speed
                if($bw_download) {
                    $data['username'] = $_POST['username'];
                        ...
                        $this->db->insert($this->_table_radreply,$data); // insert into
//radreply account table
                }
...
//radreply account table
                ...
                if($_POST['valid_until']){
                        ...
                        $radreply = array('username' => $data['username'], 'attribute' =>
'WISPr-Session-Terminate-Time', 'op' => ':=', 'value' =>
$date_radreply);
...
//radreply account table
                ...
                $_POST['valid_until'] = $date; // so we have date format instead of
//valid until duration (days)
                $this->db->insert($this->_table,$_POST); //insert into postpaid account table
                $this->db->insert($this->_table_radcheck,$radcheck_value);              //insert
//into radcheck account table
        ...
        function deleteAccount(){
                ...
                $this->db->where('username',$this->uri->segment(3));
                $this->db->delete($this->_table_radcheck);              //delete from radcheck
//account table
        ...
        function editAccount(){
                ...
                $this->db->update($this->_table_radreply, array('value' =>
$ci->config->item('postpaid_acct_interim_interval')));
                }
                $this->db->trans_complete();
        }
        ...
        function getAccountStatistic(){
                ...
                //account used
                $account_used = $this->db->query('select * from
postpaid_account_list where time_used is not NULL');
